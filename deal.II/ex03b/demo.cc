...
int main()
{
   ...
   Triangulation<dim> triangulation;
   {
      ...
      GridGenerator::hyper_cube (temp_triangulation);
      GridGenerator::convert_hypercube_to_simplex_mesh (temp_triangulation, triangulation);
   }
   triangulation.refine_global (4);

   // Degree=1 mapping for linear triangles
